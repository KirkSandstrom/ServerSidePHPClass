...
<html lang="en">
	<head>
		...
		<meta name="author" content="Kirk Sandstrom">
	  	<title><?=$title?></title> <!-- Change for each assignment -->
	...
	<body>
		...
		<main>
			<div class="container">
				...
				<li><a href="index.php?route=users/list">Users List</a></li>
        <li><a href="index.php?route=comments/list">Comments List</a></li>
